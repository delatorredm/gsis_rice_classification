...
var geomtest = 
    ...
    ee.Geometry.Polygon(
        [[[122.43398229759006, 10.726544787239716],
          [122.43398229759006, 10.722328210813425],
          [122.43878881614475, 10.722328210813425],
          [122.43878881614475, 10.726544787239716]]], null, false);
...
for(var i = 0; i < 10; i++) {clusterList.push(i)}
/********                           END                         ***********/
...
clusterList.forEach(function(class_num) {
  ...
  * ====================================================================== */
  ...
  var tableWithStats = maskedS2IC_clip.map(function(im) {
