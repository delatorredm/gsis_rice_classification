...
* SAMPLE LAYERS
* ====================================================================== */
var clippedImage = image.clipToCollection(table);
var sample_pts = clippedImage.sample({region: table, numPixels: 900, seed: 10, geometries: true});
print(sample_pts)
Map.addLayer(sample_pts)

Export.table.toDrive({
  collection: sample_pts, 
  description: "sample_pts", 
  // folder, 
  fileNamePrefix: "sample_pts", 
  fileFormat: 'KMZ', 
  // selectors
});
