...
var slopeMask = slope.lte(2); // slope less than 2 deg
var elevationMask = srtm.lte(1500); // elevation less than 1500 masl
...
var training = maskedS2IC.median().sample({
  region: geogBounds,
  scale: 10,
  numPixels: 5000
});
...
var result = maskedS2IC.median().cluster(clusterer);
